...
# Loop through each classifier and evaluate using 5-fold cross-validation
for name, clf in clf_list:
    try:
        ...
        # Fit the model on the full dataset after cross-validation
...
save_all_models(all_models, '/home/ndo/vardict_ML/models_output/SL_19_models_normalized_crossVal.pkl')
